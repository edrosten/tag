...
static bool fourPointSolver ( const std::vector<TooN::Vector<3> > & points, std::vector<TooN::Vector<3> > & myPixels, TooN::Vector<6> & distances, std::vector<TooN::Vector<2> > & length){
    TooN::Matrix<5> A;
    TooN::Vector<5> v4, v5;
    TooN::Matrix<7,3> B;
    TooN::Vector<3> bnull;
